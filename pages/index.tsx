          ...
          <div className="col-12 col-md-6">
            <div className={styles.wrapper}>
              ...
              <div className={styles.button}>
                <Link className="btn-primary" href="/about"><div className={styles.button_text}>詳しくみる</div></Link>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="overlay">
                  <div className={styles.overlay_card}>
                    ...
                    <div className={styles.overlay_card_button}>
                      <Link className="btn-primary" href="/curriculum"><div className={styles.button_text}>詳しくみる</div></Link>
                    </div>
                  </div>
                </div>
              </div>
