    ...
    <>
          ...
          <div className="col-12 col-md-6">
            <div className={styles.wrapper}>
              ...
              <div className={styles.button}>
                <Link className="btn-primary" href="/somei_juku_sample/about"><div className={styles.button_text}>詳しくみる</div></Link>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className={styles.overlay_card_wrapper}>
                ...
                <div className="overlay">
                  <div className={styles.overlay_card}>
                    ...
                    <div className={styles.overlay_card_content}>我が予備校はチーム医療全科目の先生が一人の生徒状況、得意不得意、医師への資質などを情報共有していくスタイル</div>
                    <div className={styles.overlay_card_button}>
                      <Link className="btn-primary" href="/somei_juku_sample/curriculum"><div className={styles.button_text}>詳しくみる</div></Link>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-12 col-md-4">
            <div className="container">
              <div className={styles.overlay_card_wrapper}>
                ...
                <div className="overlay">
                  <div className={styles.overlay_card}>
                    <div className={styles.overlay_card_title}>オーダーメイド学習</div>
                    <div className={styles.overlay_card_content}>オーダーメイドホームワーク一人一人の能力、素質に体質に合わせた授業展開、宿題の提供</div>
                    <div className={styles.overlay_card_button}>
                      <Link className="btn-primary" href="/somei_juku_sample/curriculum"><div className={styles.button_text}>詳しくみる</div></Link>
                    </div>
                  </div>
          ...
          <div className="col-12 col-md-4">
            <div className="container p-3">
              ...
              <img src={card3.src} className="img" alt=""/>
                <div className="overlay">
                  <div className={styles.overlay_card}>
                    <div className={styles.overlay_card_title}>塾のコンセプト</div>
                    <div className={styles.overlay_card_content}>大手予備校人気プロ講師のみ在籍を可能した最強プロ講師医学部専門予備校</div>
                    <div className={styles.overlay_card_button}>
                      <Link className="btn-primary" href="/somei_juku_sample/curriculum"><div className={styles.button_text}>詳しくみる</div></Link>
                    </div>
                  </div>
      ...
      <section className={`${styles.section} ${styles.bg_gray}`}>
        <div className={styles.reserve}>
          <CherryText><h2 className={styles.reserve_title}>資料請求/体験授業の<br />ご予約受付中</h2></CherryText>
          <div className={styles.reserve_button}><Link className="btn-secondary" href="/"><div className={styles.button_text}>応募する</div></Link></div>
          <div className={styles.reserve_contact}>お電話でも受付ています。お気軽にご連絡ください。<br />電話番号：03-0000-0000<br />受付時間：月〜金 11:00-17:00</div>
        </div>
      </section>
      <section className={styles.section}>
        <div className="row">
          <div className="col-12 col-md-4">
            <div className={styles.info_title}>
              <CherryText><h2 className={styles.subtitle}>お知らせ</h2></CherryText>
            </div>
          </div>
